...
/*
 *		Initialize Settings For Splitting The Image
 ...
 */
void ImageSplitter::initializeSettingsForSplittingTheImage(int widthOfUsedImage, int heightOfUsedImage, unsigned char* pixelsFromUsedImage) {
	chunkSize = 4;
 ...
 */
int ImageSplitter::calculateHowManyChunksAreNeeded(int width, int height) {
 ...
 */
void ImageSplitter::initializeVectorOfChunks() {
 ...
 */
std::vector<int> ImageSplitter::initializeArrayOfPixelColorValues() {
 ...
 */
void ImageSplitter::startCompression() {
 ...
 */
void ImageSplitter::sliceImageIntoChunks() {
 ...
 */
void ImageSplitter::calculateAllPixelsNeededForRowOfChunks(int startingPoint) {
 ...
 */
void ImageSplitter::calculatePixelsFromOneRowOfImage(int startingPoint) {
 ...
 */
void ImageSplitter::sliceImageIntoOneChunkRow(int startingPixel) {
 ...
 */
int ImageSplitter::getCurrentChunkStartingPixelPosition() {
